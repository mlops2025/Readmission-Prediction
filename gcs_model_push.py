...
# Paths
PROJECT_DIR = #replace with your path
LOG_FILE_PATH = os.path.join(PROJECT_DIR, "dags", "logs", "gcs_model_push.log")

#key path
KEY_PATH = " " # replace json keypath
...
def push_to_gcp():
    ...
    stage = "Staging"  
    local_model_path = "/src/final_model" #replace path
